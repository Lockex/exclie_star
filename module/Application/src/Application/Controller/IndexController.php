...
class IndexController extends AbstractActionController {
	...
	public function loginAction() {
		...
		if ($this->getRequest()->isPost()) {
			...
			try {
				$user = $this->getEntityManager()->createQuery("SELECT u FROM Application\Entity\Usuarios u WHERE u.EMAIL = '$usernameOrEmail' OR u.USUARIO = '$usernameOrEmail'")->getResult(\Doctrine\ORM\Query::HYDRATE_OBJECT);
				$user = $user[0];
				...
				$adapter->setIdentityValue($user->getUSUARIO());
